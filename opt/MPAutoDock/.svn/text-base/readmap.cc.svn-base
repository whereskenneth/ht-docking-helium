/*
 ...
 $Id: readmap.cc,v 1.2 2010/07/30 23:51:12 pkcoff Exp $
...
extern char atomTypeMap[MAX_MAPS][3];
...
//    printf("readmap atomTypeMap[%d] is %s\n", i,atomTypeMap[i]);
//  }
