/*
 ...
 $Id: analysis.cc,v 1.2 2010/04/14 21:02:01 pkcoff Exp $
...
#pragma omp threadprivate(label, rec14, rec9, clu_rms, crdSave, crd, elec, elec_total, ref_crds, ref_rms, cluster, isort)
