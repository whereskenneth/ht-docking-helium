/*
 ...
 $Id: gs.cc,v 1.3 2010/07/30 23:51:12 pkcoff Exp $
...
// all references to global evaluate object in this file have been replaced with evaluate[threadID] to use the correct array element corresponding to the thread ID
...
#ifdef POWER7
// pkcoff 2010-09-01: cast the int arg to float for the log function to get around matching error on power 7      
         L += log((double)size+1-j) - log((double)j);
#else
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::mutation(Population &pure) for threadID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::mutation(Population &pure) for threadID %d AFTER check_table(ranf())\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::mutation(Population &pure) for threadID %d END)\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) for thread ID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) point 2 for threadID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) inside loop for threadID %d\n",threadID);
#endif /* DEBUG */

      // The two individuals undergoing crossover are original_population[ordering[i]] and original_population[ordering[i+1]]

#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) before if ranf for threadID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) before CASE for threadID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) AFTER case for threadID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) after original_population for threadID %d\n",threadID);
#endif /* DEBUG */
...
#ifdef LIGHTERDEBUG
   (void)fprintf(logFile, "gs.cc/void Genetic_Algorithm::crossover(Population &original_population) END  threadID %d\n",threadID);
#endif /* DEBUG */
...
int Genetic_Algorithm::search(Population &solutions)
{
...
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) solutions.num_individuals is %d for threadID %d\n",solutions.num_individuals(),threadID);
#endif /* } DEBUG */
...
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) crossover for threadID %d\n",threadID);
#endif /* } DEBUG */
...
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) AFTER crossover for threadID %d\n",threadID);
#endif /* } DEBUG */
   ...
   mutation(newPop);
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) AFTER mutation for threadID %d\n",threadID);
#endif /* } DEBUG */
...
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) AFTER solutions = newPop for threadID %d\n",threadID);
#endif /* } DEBUG */
...
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) before outputEveryNgens for threadID %d\n",threadID);
#endif /* } DEBUG */
   
   if (generations%outputEveryNgens == 0) {

#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) IN outputEveryNgens for threadID %d\n",threadID);
#endif /* } DEBUG */
...
#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) doing eval for threadID %d\n",threadID);
#endif /* } DEBUG */
...
//               evaluate[threadID].evals() );
	    sprintf(searchResultsLine[threadID],"Generation: %3u   Oldest's energy: %.3f    Lowest energy: %.3f    Num.evals.: %ld   Timing: ", 
               generations, solutions[oldestIndividual].value(Normal_Eval), solutions[fittestIndividual].value(Normal_Eval), 
               evaluate[threadID].evals() );
...
//               evaluate[threadID].evals() );
	    sprintf(searchResultsLine[threadID],"Generation: %3u   Oldest ind.: %u/%u, age: %lu, energy: %.3f    Lowest energy individual: %u/%u, age: %lu, energy: %.3f    Num.evals.: %ld    Timing: ", 
               generations, oldestIndividual+1, solutions.num_individuals(), solutions[oldestIndividual].age, 
               solutions[oldestIndividual].value(Normal_Eval), fittestIndividual+1, solutions.num_individuals(), 
               solutions[fittestIndividual].age, solutions[fittestIndividual].value(Normal_Eval), 
               evaluate[threadID].evals() );
...
//pkcoff - write to search results buffer
//               (void)fprintf(logFile,"Generation: %3u   Oldest's energy: %.3f    Lowest energy: %.3f    Num.evals.: %ld   Timing: ", 
//               generations, solutions[oldestIndividual].value(Normal_Eval), solutions[fittestIndividual].value(Normal_Eval), evaluate[threadID].evals() );
	    sprintf(searchResultsLine[threadID],"Generation: %3u   Oldest's energy: %.3f    Lowest energy: %.3f    Num.evals.: %ld   Timing: ", 
               generations, solutions[oldestIndividual].value(Normal_Eval), solutions[fittestIndividual].value(Normal_Eval), evaluate[threadID].evals() );               
	    strcat(searchResultsBuffer[threadID], searchResultsLine[threadID]);
     #else
...
//               generations, oldestIndividual+1, solutions.num_individuals(), solutions[oldestIndividual].age, 
//               solutions[oldestIndividual].value(Normal_Eval), fittestIndividual+1, solutions.num_individuals(), 
//               solutions[fittestIndividual].age, solutions[fittestIndividual].value(Normal_Eval), evaluate[threadID].evals() );
	    sprintf(searchResultsLine[threadID],"Generation: %3u   Oldest: %u/%u, age: %lu, energy: %.3f    Lowest energy individual: %u/%u, age: %lu, energy: %.3f    Num.evals.: %ld   Timing: ", 
               generations, oldestIndividual+1, solutions.num_individuals(), solutions[oldestIndividual].age, 
               solutions[oldestIndividual].value(Normal_Eval), fittestIndividual+1, solutions.num_individuals(), 
               solutions[fittestIndividual].age, solutions[fittestIndividual].value(Normal_Eval), evaluate[threadID].evals() );
	    strcat(searchResultsBuffer[threadID], searchResultsLine[threadID]);
       ...
       timesyshms_buffer( genEnd - genStart, &tms_genStart, &tms_genEnd );
       genStart = times( &tms_genStart );
   }

#ifdef LIGHTERDEBUG /* DEBUG { */
   (void)fprintf(logFile, "gs.cc/int Genetic_Algorithm::search(Population &solutions) END for threadID %d\n",threadID);
#endif /* } DEBUG */
