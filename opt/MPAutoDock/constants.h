/*
 ...
 $Id: constants.h,v 1.4 2010/07/30 23:51:12 pkcoff Exp $
...
// this is the number of threads to use for openmp
#ifndef MAX_NUM_THREADS
#define MAX_NUM_THREADS 16
#endif

// this is the length of the buffers for buffering the search output for each iteration
#define DLG_BUFFER_LENGTH 100000
#define DLG_LINE_LENGTH 2000

// these are the different seed types
#define SAME_SEED 0
#define DEFAULT_SEED 1
#define UNIQUE_NODE_SEED 2
#define SAME_SEED_CONSTANT 1270058692

// these are the different map file usage types
#define RELOAD_MAPS 0
#define REUSE_MAPS 1
