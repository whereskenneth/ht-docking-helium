...
int main(int argc, char *argv[]) {
	...
	while (notatend) {
		...
		if (prefix.size()) { 
			...
			sprintf(molcount_array, "%010i", molcounter);

			std::string molcounter_string(molcount_array);

			std::string prefix_molcounter = prefix + molcounter_string;
